    ...
    try {
      ...
      if (email === emailDecodificado) {
        ...
        if (confirmado) {
          ...
          const whatsapp = this.WhatsAppSender.convertirEnNumeroWhatsApp(usuario.celular)
          this.WhatsAppSender.enviarMensaje(whatsapp, 'Ha confirmado su cuenta correctamente')
        } else {
